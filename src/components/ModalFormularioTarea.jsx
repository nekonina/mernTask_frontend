...
const ModalFormularioTarea = () => {
    const {modal, handleModal, alerta, mostrarAlerta, submitTarea, tarea} = useProyect()
    ...
    return (
        <Transition.Root show={modal.formTarea} as={Fragment}>
            <Dialog as="div" className="fixed z-10 inset-0 overflow-y-auto" onClose={()=> handleModal('formTarea')}>
                    ...
                    >
                            ...
                            <div className="sm:flex sm:items-start">
                                <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                                    <Dialog.Title as="h2" className="text-4xl leading-6 font-bold text-gray-900">
                                        {data.id ? 'Actualizar Tarea' : 'Crear Tarea:'}
                                    </Dialog.Title>
                                    {
                                        alerta.msg != ''
                                    ...
                                    <form onSubmit={handleSubmit} className="my-10">
                                        ...
                                        <div className="mb-5">
                                            ...
                                            <select
                                                ...
                                                onChange={e => setData({...data, prioridad: e.target.value})}
                                            >
                                        ...
                                        <input 
                                            ...
                                            value={ data.id ? 'Guardar cambios' : 'Crear Tarea'}
                                        />
                                    </form>
                                </div>
                            </div>
